...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-03-2016 a las 04:37:31
...
(2, 1, '2016-03-09', 'CONTADO', 3, 35, 245000, 100000, 700000, 455000, 3, 151667, 455000),
...
--
ALTER TABLE `movimientoe`
  MODIFY `id_movimiento_e` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=129;
--
-- AUTO_INCREMENT de la tabla `movimientot`
--
ALTER TABLE `movimientot`
  MODIFY `id_movimiento_t` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=24;
--
